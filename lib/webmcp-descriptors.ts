...
export const SANDBOX_TOOL_DESCRIPTORS: ToolDescriptor[] = [
  ...
  { name: "import_sample_gedcom", description: "Parse the bundled fictional Rowan GEDCOM and replace the sandbox tree. Undo restores the previous tree.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
