...
describe("upload policy", () => {
  it("accepts a representative family archive ZIP", () => {
    expect(validateUploadBatch([{ size: 12_000_000 }])).toBeNull();
    expect(MAX_UPLOAD_MANIFEST_CHARS).toBeGreaterThan(27_000);
  });
